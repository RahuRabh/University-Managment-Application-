...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1436983692ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=user&table=form">`user`.`form`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=user&table=login">`user`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=user&table=add">`user`.`add`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="22747527697c376258704d303f3f2d27">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `add`</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `add` DROP `password`, DROP `vtu_id`, DROP `registration_number`, DROP `batch`, DROP `phone_number`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="user" targettable="add">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `add`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="user" targettable="form">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `form`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="user" targettable="form">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `form`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="user" targettable="login">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `login` (`Id`, `username`, `Password`, `vtu id`, `registration number`, `email`, `DOB`, `Batch`, `Phone Number`, `Address`, `usertype`) VALUES (NULL, &#039;vtu14424&#039;, &#039;vtu14424&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;user&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="user" targettable="login">
                            <div class="action_content">
